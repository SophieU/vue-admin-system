          ...
          <Row :gutter="25">
            <Col span="12">
              <FormItem label="消息主题" prop="title">
                <Input :disabled="viewInfo" v-model="msgForm.title" :maxlength="100" placeholder="消息主题最多100字"/>
              </FormItem>
              <FormItem label="消息内容" prop="content">
                <Input :maxlength="150" placeholder="最多150字" :disabled="viewInfo" v-model="msgForm.content" type="textarea" :rows="5"/>
              </FormItem>
            </Col>
            <Col span="12">
